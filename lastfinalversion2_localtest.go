...
//
//	go build -tags localtest -o rat_local.exe lastfinalversion2.go lastfinalversion2_localtest.go
//
// Behavior:
...
//
// Run server locally first, e.g.: node server.js  (TCP bind from c2.sqlite settings, often 2026)
